...
class CreateMerchantCodesAndRatesHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('merchant_codes_and_rates_history', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('merchant_codes_and_rates_history');
    }
}
