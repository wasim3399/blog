...
class CreateUpdatedCpTransactionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('updated_cp_transactions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('updated_cp_transactions');
    }
}
