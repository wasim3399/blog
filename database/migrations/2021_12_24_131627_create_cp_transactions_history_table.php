...
class CreateCpTransactionsHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cp_transactions_history', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('cp_transactions_history');
    }
}
