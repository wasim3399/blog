...
class CreateTempCpTransactionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('temp_cp_transactions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('temp_cp_transactions');
    }
}
